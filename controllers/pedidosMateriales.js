...
const createPedido = async (req, res, next) => {
  try {
    ...
    checkExists(materialesNoEncontrados === 0, "Algunos materiales no fueron encontrados", 404);
...
const updatePedido = async (req, res, next) => {
  try {
    ...
    checkExists(pedidoMaterialActualizado, "No se encontró el pedido de materiales", 404);
...
const deletePedido = async (req, res, next) => {
  try {
    ...
    checkExists(pedidoMaterialEliminado, "No se encontró el pedido de materiales", 404);
