...
const loginCallback = async (req, res, next) => {
  ...
  checkExists(code, "No se encontró el código de autorización");
  ...
  try {
    ...
    isValidEmail = (email.endsWith("@alu.inspt.utn.edu.ar") || email.endsWith("@inspt.utn.edu.ar"));

    checkExists(isValidEmail, "Acceso denegado", 403);
